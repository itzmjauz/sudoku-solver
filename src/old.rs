...
impl World {
    ...
    // solve step - we update all the options of each cell
    fn update_options(&mut self) {
        for y in 0..9 {
            for x in 0..9 {
                if self.world[x][y].value == 0 {
    ...
    fn neighbours_row(&self, x, y) {

    }

    fn neighbours_col(&self, x, y) {
